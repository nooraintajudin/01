...
<div id="main" class="box">
    ...
    <div id="header">
     ...
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                ...
                <li><a href="staf.html">Keluar<span class="tab-l"></span><span class="tab-r"></span></a></li>
            </ul>
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">Anda disini: <a>Selamat Datang ke Laman Pembantu Perubatan <?php echo $_SESSION['no_tentera']; ?></a></p>
            <hr class="noscreen" />
		...
		<center><img src="images/100416_bloodtest_THUMB_LARGE.jpg" width=340 height=240></td></center>
