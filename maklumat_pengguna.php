...
<div id="main" class="box">
    ...
    <div id="page-in" class="box">
		...
		// echo"<p> Senarai Maklumat Pengguna </p>";
		echo "<table>";
		echo "<tr>";
			echo "<th>No Tentera</th>";
		...
		{  
		 echo "<tr>";
			echo "<td>" . $row['no_tentera'] . "</td>";
			echo "<td>" . $row['kata_laluan'] . "</td>";
			echo "<td>" . $row['emel'] . "</td>";
		...
		?>
			...
			<button type="button"><a href="tambah.html">Tambah</a></button>
			<button type="submit"><a href="edit.html">Kemaskini</a></button>
			<button type="submit"><a href="delete.html">Padam</a></button>
